---
name: ask-artie-rollout
description: Use for single, EP, album, tour, content, or merch rollout planning with cadence, channel priorities, and measurable checkpoints.
compatibility: opencode
---

## What To Do

Create practical rollout plans for independent artists. Make the plan usable by a small team without assuming a label-size budget.
...
- Prefer 2-6 week plans unless the user gives a date.
